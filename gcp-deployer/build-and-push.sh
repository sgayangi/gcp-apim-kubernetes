...
if [ -d "wso2am-acp" ]; then
    ...
    COPYFILE_DISABLE=1 tar -czf wso2am-acp-4.5.0.tgz --exclude='._*' --exclude='.DS_Store' wso2am-acp/
fi
...
docker build --platform linux/amd64 \
    ...
    --tag us-docker.pkg.dev/wso2-marketplace-public/wso2-marketplace/deployer:4.5 \
    --tag us-docker.pkg.dev/wso2-marketplace-public/wso2-marketplace/deployer:4.5.0 \
    -f Dockerfile .

# Push the image as a single manifest
echo "Pushing Docker image..."
docker push us-docker.pkg.dev/wso2-marketplace-public/wso2-marketplace/deployer:4.5

# Extract SHA256 from the pushed image
echo "Extracting image SHA256..."
export IMAGE_SHA=$(docker inspect --format='{{index .RepoDigests 0}}' us-docker.pkg.dev/wso2-marketplace-public/wso2-marketplace/deployer:4.5 | cut -d'@' -f2)

echo "=== Build and push complete ==="
echo "Image: us-docker.pkg.dev/wso2-marketplace-public/wso2-marketplace/deployer:4.5"
...
# Tag the mutated image with version tags
echo "Tagging mutated image with 4.5 and 4.5.0..."
crane tag us-docker.pkg.dev/wso2-marketplace-public/wso2-marketplace/deployer@$MUTATED_SHA 4.5
crane tag us-docker.pkg.dev/wso2-marketplace-public/wso2-marketplace/deployer@$MUTATED_SHA 4.5.0

echo "=== All operations complete ==="
echo "Final image with tags: us-docker.pkg.dev/wso2-marketplace-public/wso2-marketplace/deployer:4.5"
echo "Final image with tags: us-docker.pkg.dev/wso2-marketplace-public/wso2-marketplace/deployer:4.5.0"
